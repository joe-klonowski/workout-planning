...
- After editing code, use the start.sh script to launch both the frontend and backend so that it's easy for me, the human developer, to manually QA the changes by looking at and clicking around the UI.
