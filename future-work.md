...
## Known bugs
- I updated the weekly targets in the weekly_targets.json file and since I updated it, the weekly targets are missing from the week summary on the right side of the UI.
