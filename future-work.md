...
- Several frontend tests are showing a warning like: An update to DayTimeSlot inside a test was not wrapped in act(...). Fix this by using waitFor from React Testing Library to wait for the async state updates.
